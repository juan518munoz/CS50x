...
-- speed at which the AI will move
PADDLE_AI_SPEED = 150
...
function love.update(dt)
    ...
    -- Paddle1 AI
    -- Check if player and ball are in a different possition
    if player1.y -10 ~= ball.y and ball.x < VIRTUAL_WIDTH / 2 + 100 and gameState == "play" then
        -- Set AI movement speed
        if ball.y < player1.y then
            player1.dy = -PADDLE_AI_SPEED
        else    
            player1.dy = PADDLE_AI_SPEED
        end
    end
    ...
    -- Paddle2 AI
    -- Check if player and ball are in a different possition
    if player2.y -10 ~= ball.y and ball.x > VIRTUAL_WIDTH / 2 - 100 and gameState == "play" then
        -- Set AI movement speed
